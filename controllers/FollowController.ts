...
export default class FollowController implements FollowControllerI {
  ...
  public static getInstance = (app: Express): FollowController => {
    if (FollowController.followController === null) {
      ...
      app.post('/api/users/:uid/follow/:auid', FollowController.followController.userFollowsUser);
      app.delete('/api/users/:uid/follow/:auid', FollowController.followController.userUnfollowsUser);
      app.get('/api/users/:uid/followers', FollowController.followController.findAllUsersFollowers);
      app.get('/api/users/:uid/followees', FollowController.followController.findAllUsersFollowees);
    }
